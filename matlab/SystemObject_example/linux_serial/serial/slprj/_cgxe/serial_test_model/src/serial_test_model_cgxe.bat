@echo off
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2016b\MW_MinGW_4_9\bin\gcc
                set CXXCOMPILER=C:\ProgramData\MATLAB\SupportPackages\R2016b\MW_MinGW_4_9\bin\g++
                ...
                set DEBUGFLAGS=-g
                set LINKER=C:\ProgramData\MATLAB\SupportPackages\R2016b\MW_MinGW_4_9\bin\gcc
                set CXXLINKER=C:\ProgramData\MATLAB\SupportPackages\R2016b\MW_MinGW_4_9\bin\g++
...
gmake SHELL="cmd" -f serial_test_model_cgxe.gmk
