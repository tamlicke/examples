...
%           Number of Signals per record Logged 1 bcytes (256 max)
...
% Steve Kuznicki
function [datapts, numpts] = read_binary_file(dataFile)
%%
datapts = 0;
numpts = 0;

if nargin == 0
    dataFile = 'bin_log_A.bin';
end
...
datapts =  transpose(datapts); % to conform to how MATLAB plots rows versus columns....
