...
*/
public class ShapeTypeExtendedSubscriber extends Application implements AutoCloseable {

    private DomainParticipant participant = null; // Usually one per application
    private ShapeTypeExtendedDataReader reader = null;
    private final ShapeTypeExtendedSeq dataSeq = new ShapeTypeExtendedSeq();
    ...
    private void runApplication() {
        ...
        // This DataReader reads data on "Example ShapeTypeExtended" Topic
        reader = (ShapeTypeExtendedDataReader) Objects.requireNonNull(
    ...
    public static void main(String[] args) {
        ...
        try (ShapeTypeExtendedSubscriber subscriberApplication = new ShapeTypeExtendedSubscriber()) {
