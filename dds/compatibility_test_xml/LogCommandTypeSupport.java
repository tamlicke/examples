...
public class LogCommandTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "LogCommand";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=SourceEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=LogCommandEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=LogLevelEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += SourceEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += LogCommandEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += LogLevelEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += SourceEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.target);

        currentAlignment += LogCommandEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.command);

        currentAlignment += LogLevelEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += SourceEnumTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=SourceEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            SourceEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            LogCommandEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.command, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            LogLevelEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.level, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            SourceEnumTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                LogCommand typedSrc = (LogCommand) src;      
                dst.inBaseClass = false;
                SourceEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.target = (SourceEnum)SourceEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
                typedDst.command = (LogCommandEnum)LogCommandEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.command, src, false, true, endpoint_plugin_qos);     
                typedDst.level = (LogLevelEnum)LogLevelEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.level, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_key) {
            ...
            typedDst.target = (SourceEnum)SourceEnumTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
            if (!xcdr1 && !inBaseClass_tmp ) {
                buffer.restore(DHtmpSize, (int) (DHtmpPosition + DHtmpLength));
            }
        }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            SourceEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            LogCommandEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            LogLevelEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            typedDst.target = (SourceEnum)SourceEnumTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
