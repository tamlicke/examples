...
/**
* A sequence of TrocarFrame instances.
*/
public final class TrocarFrameSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TrocarFrameSeq() {
        super(TrocarFrame.class);
    }

    public TrocarFrameSeq (int initialMaximum) {
        super(TrocarFrame.class, initialMaximum);
    }

    public TrocarFrameSeq (Collection<?> elements) {
        super(TrocarFrame.class, elements);
    }

    public  TrocarFrame get(int index) { 
        return (TrocarFrame) super.get(index); 
    }
