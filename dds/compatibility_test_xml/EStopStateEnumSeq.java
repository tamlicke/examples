...
/**
* A sequence of EStopStateEnum instances.
*/
public final class EStopStateEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EStopStateEnumSeq() {
        super(EStopStateEnum.class);
    }

    public EStopStateEnumSeq (int initialMaximum) {
        super(EStopStateEnum.class, initialMaximum);
    }

    public EStopStateEnumSeq (Collection<?> elements) {
        super(EStopStateEnum.class, elements);
    }

    public  EStopStateEnum get(int index) { 
        return (EStopStateEnum) super.get(index); 
    }
