...
/**
* A sequence of LogLevelEnum instances.
*/
public final class LogLevelEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LogLevelEnumSeq() {
        super(LogLevelEnum.class);
    }

    public LogLevelEnumSeq (int initialMaximum) {
        super(LogLevelEnum.class, initialMaximum);
    }

    public LogLevelEnumSeq (Collection<?> elements) {
        super(LogLevelEnum.class, elements);
    }

    public  LogLevelEnum get(int index) { 
        return (LogLevelEnum) super.get(index); 
    }
