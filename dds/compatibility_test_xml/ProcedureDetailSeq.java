...
/**
* A sequence of ProcedureDetail instances.
*/
public final class ProcedureDetailSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProcedureDetailSeq() {
        super(ProcedureDetail.class);
    }

    public ProcedureDetailSeq (int initialMaximum) {
        super(ProcedureDetail.class, initialMaximum);
    }

    public ProcedureDetailSeq (Collection<?> elements) {
        super(ProcedureDetail.class, elements);
    }

    public  ProcedureDetail get(int index) { 
        return (ProcedureDetail) super.get(index); 
    }
