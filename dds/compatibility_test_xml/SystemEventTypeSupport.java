...
public class SystemEventTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "SystemEvent";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=EventEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += EventEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += EventEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=EventEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (128)+1);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            SourceEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            EventEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.event, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                SystemEvent typedSrc = (SystemEvent) src;      
                dst.inBaseClass = false;
                SourceEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.source, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                EventEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.event, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                dst.writeString(typedSrc.detail,128);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.source = (SourceEnum)SourceEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.source, src, false, true, endpoint_plugin_qos);     
                typedDst.event = (EventEnum)EventEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.event, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            EventEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
