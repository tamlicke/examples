...
public class RobotCommandTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "RobotCommand";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=RobotEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=RobotCommandEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=PositionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=TrocarFrameTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += RobotEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += RobotCommandEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += PositionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += TrocarFrameTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += RobotEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.robot);

        currentAlignment += RobotCommandEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.command);

        currentAlignment += PositionEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.position);

        currentAlignment += TrocarFrameTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=RobotEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=RobotCommandEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=PositionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=TrocarFrameTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            RobotEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.robot, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            RobotCommandEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.command, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            PositionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            TrocarFrameTypeSupport.get_instance().serialize(endpoint_data, typedSrc.trocar_frame, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                RobotCommand typedSrc = (RobotCommand) src;      
                dst.inBaseClass = false;
                RobotEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.robot, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                RobotCommandEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.command, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                PositionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                TrocarFrameTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.trocar_frame, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.robot = (RobotEnum)RobotEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.robot, src, false, true, endpoint_plugin_qos);     
                typedDst.command = (RobotCommandEnum)RobotCommandEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.command, src, false, true, endpoint_plugin_qos);     
                typedDst.position = (PositionEnum)PositionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.position, src, false, true, endpoint_plugin_qos);     
                typedDst.trocar_frame = (TrocarFrame)TrocarFrameTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.trocar_frame, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            RobotEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            RobotCommandEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            PositionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            TrocarFrameTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
