...
public class ArmMovementCommandTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "ArmMovementCommand";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=DirectionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DirectionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += DirectionEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=DirectionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DirectionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.direction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ArmMovementCommand typedSrc = (ArmMovementCommand) src;      
                dst.inBaseClass = false;
                DirectionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.direction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.direction = (DirectionEnum)DirectionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.direction, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DirectionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
