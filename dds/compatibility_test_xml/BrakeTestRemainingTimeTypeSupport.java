...
* BrakeTestRemainingTime
*/

public class BrakeTestRemainingTimeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "BrakeTestRemainingTime";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BrakeTestRemainingTimeTypeSupport _singleton
    = new BrakeTestRemainingTimeTypeSupport();
    ...
    */
    public static BrakeTestRemainingTimeTypeSupport get_instance() {
        return _singleton;
    }

    public static BrakeTestRemainingTimeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BrakeTestRemainingTimeTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return BrakeTestRemainingTime.create();
    }
    ...
    public Object create_key() {
        return new BrakeTestRemainingTime();
    }
    ...
    public Class<?> get_type() {
        return BrakeTestRemainingTime.class;
    }
    ...
    * <code>this</code> is not a <code>BrakeTestRemainingTime</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        BrakeTestRemainingTime typedDst = (BrakeTestRemainingTime) destination;
        BrakeTestRemainingTime typedSrc = (BrakeTestRemainingTime) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        BrakeTestRemainingTime typedSrc = (BrakeTestRemainingTime) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.seconds_remaining);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BrakeTestRemainingTime typedDst = (BrakeTestRemainingTime) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                ...
                typedDst.seconds_remaining = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BrakeTestRemainingTime typedDst = (BrakeTestRemainingTime) sample;
            deserialize_sample(
    ...
    int mask) {
        return new BrakeTestRemainingTimeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BrakeTestRemainingTimeDataReader(native_reader, listener, mask, this);   
    ...
    protected BrakeTestRemainingTimeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, BrakeTestRemainingTimeTypeCode.VALUE, BrakeTestRemainingTime.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BrakeTestRemainingTimeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, BrakeTestRemainingTimeTypeCode.VALUE, BrakeTestRemainingTime.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
