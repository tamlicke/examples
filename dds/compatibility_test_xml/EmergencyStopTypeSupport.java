...
public class EmergencyStopTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "EmergencyStop";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EmergencyStopTypeSupport _singleton
    = new EmergencyStopTypeSupport();
    ...
    */
    public static EmergencyStopTypeSupport get_instance() {
        return _singleton;
    }

    public static EmergencyStopTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EmergencyStopTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>EmergencyStop</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        EmergencyStop typedDst = (EmergencyStop) destination;
        EmergencyStop typedSrc = (EmergencyStop) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=EStopStateEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += EStopStateEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        EmergencyStop typedSrc = (EmergencyStop) sample;
        ...
        currentAlignment += EStopStateEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.state);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=EStopStateEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            EStopStateEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.state, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                EmergencyStop typedSrc = (EmergencyStop) src;      
                dst.inBaseClass = false;
                EStopStateEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.state, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EmergencyStop typedDst = (EmergencyStop) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.state = (EStopStateEnum)EStopStateEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.state, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            EStopStateEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EmergencyStop typedDst = (EmergencyStop) sample;
            deserialize_sample(
    ...
    int mask) {
        return new EmergencyStopDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new EmergencyStopDataReader(native_reader, listener, mask, this);   
    ...
    protected EmergencyStopTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, EmergencyStopTypeCode.VALUE, EmergencyStop.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EmergencyStopTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, EmergencyStopTypeCode.VALUE, EmergencyStop.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
