...
/**
* A sequence of RobotCommandEnum instances.
*/
public final class RobotCommandEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RobotCommandEnumSeq() {
        super(RobotCommandEnum.class);
    }

    public RobotCommandEnumSeq (int initialMaximum) {
        super(RobotCommandEnum.class, initialMaximum);
    }

    public RobotCommandEnumSeq (Collection<?> elements) {
        super(RobotCommandEnum.class, elements);
    }

    public  RobotCommandEnum get(int index) { 
        return (RobotCommandEnum) super.get(index); 
    }
