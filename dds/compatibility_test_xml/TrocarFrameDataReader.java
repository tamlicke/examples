...
/**
* A reader for the TrocarFrame user type.
*/
public class TrocarFrameDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(TrocarFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(TrocarFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(TrocarFrameSeq received_data, 
    ...
    public void take_w_condition(TrocarFrameSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(TrocarFrame received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(TrocarFrame received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(TrocarFrameSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(TrocarFrameSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(TrocarFrameSeq received_data,
    ...
    public void take_instance_w_condition(TrocarFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(TrocarFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(TrocarFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(TrocarFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(TrocarFrameSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(TrocarFrameSeq received_data, SampleInfoSeq info_seq) {
        return_loan_untyped(received_data, info_seq);
    }

    public void get_key_value(TrocarFrame key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(TrocarFrame key_holder) {
    ...
    /*package*/  TrocarFrameDataReader (long native_reader, DataReaderListener listener,
