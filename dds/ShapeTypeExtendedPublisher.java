...
*/
public class ShapeTypeExtendedPublisher extends Application implements AutoCloseable {
    ...
    private void runApplication() {
        ...
        // This DataWriter writes data on "Example ShapeTypeExtended" Topic
        ShapeTypeExtendedDataWriter writer = (ShapeTypeExtendedDataWriter) Objects.requireNonNull(
        ...
        ShapeTypeExtended data = new ShapeTypeExtended();
        ...
        && samplesWritten < getMaxSampleCount(); samplesWritten++) {
            ...
            System.out.println("Writing ShapeTypeExtended, count " + samplesWritten);
    ...
    public static void main(String[] args) {
        ...
        try (ShapeTypeExtendedPublisher publisherApplication = new ShapeTypeExtendedPublisher()) {
