...
public class RobotCommandEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::RobotCommandEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RobotCommandEnumTypeSupport _singleton
    = new RobotCommandEnumTypeSupport();
    ...
    */
    public static RobotCommandEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static RobotCommandEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RobotCommandEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>RobotCommandEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        RobotCommandEnum typedSrc = (RobotCommandEnum) src;
    ...
    protected RobotCommandEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, RobotCommandEnumTypeCode.VALUE, RobotCommandEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
