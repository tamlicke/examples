...
public class JointTorquesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::JointTorques";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointTorquesTypeSupport _singleton
    = new JointTorquesTypeSupport();
    ...
    */
    public static JointTorquesTypeSupport get_instance() {
        return _singleton;
    }

    public static JointTorquesTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointTorquesTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return JointTorques.create();
    }
    ...
    * <code>this</code> is not a <code>JointTorques</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        JointTorques typedDst = (JointTorques) destination;
        JointTorques typedSrc = (JointTorques) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getDoubleArrayMaxSizeSerialized(currentAlignment,  (7));
        if (include_encapsulation) {
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        JointTorques typedSrc = (JointTorques) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getDoubleArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (7));
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 7; ++i1__){
                ...
                dst.writeDouble(typedSrc.jointTorques[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            JointTorques typedDst = (JointTorques) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                for(int i1__ = 0; i1__< 7; ++i1__){
                    ...
                    typedDst.jointTorques[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            JointTorques typedDst = (JointTorques) sample;
            deserialize_sample(
    ...
    int mask) {
        return new JointTorquesDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new JointTorquesDataReader(native_reader, listener, mask, this);   
    ...
    protected JointTorquesTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, JointTorquesTypeCode.VALUE, JointTorques.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected JointTorquesTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, JointTorquesTypeCode.VALUE, JointTorques.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
