...
public class EventEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::EventEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EventEnumTypeSupport _singleton
    = new EventEnumTypeSupport();
    ...
    */
    public static EventEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static EventEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EventEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>EventEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        EventEnum typedSrc = (EventEnum) src;
    ...
    protected EventEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, EventEnumTypeCode.VALUE, EventEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
