...
/**
* A sequence of CartPositionEnum instances.
*/
public final class CartPositionEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CartPositionEnumSeq() {
        super(CartPositionEnum.class);
    }

    public CartPositionEnumSeq (int initialMaximum) {
        super(CartPositionEnum.class, initialMaximum);
    }

    public CartPositionEnumSeq (Collection<?> elements) {
        super(CartPositionEnum.class, elements);
    }

    public  CartPositionEnum get(int index) { 
        return (CartPositionEnum) super.get(index); 
    }
