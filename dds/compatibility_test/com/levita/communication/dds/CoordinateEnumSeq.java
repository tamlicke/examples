...
/**
* A sequence of CoordinateEnum instances.
*/
public final class CoordinateEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CoordinateEnumSeq() {
        super(CoordinateEnum.class);
    }

    public CoordinateEnumSeq (int initialMaximum) {
        super(CoordinateEnum.class, initialMaximum);
    }

    public CoordinateEnumSeq (Collection<?> elements) {
        super(CoordinateEnum.class, elements);
    }

    public  CoordinateEnum get(int index) { 
        return (CoordinateEnum) super.get(index); 
    }
