...
/**
* A sequence of SystemEvent instances.
*/
public final class SystemEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SystemEventSeq() {
        super(SystemEvent.class);
    }

    public SystemEventSeq (int initialMaximum) {
        super(SystemEvent.class, initialMaximum);
    }

    public SystemEventSeq (Collection<?> elements) {
        super(SystemEvent.class, elements);
    }

    public  SystemEvent get(int index) { 
        return (SystemEvent) super.get(index); 
    }
