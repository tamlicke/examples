...
/**
* A sequence of PositionEnum instances.
*/
public final class PositionEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PositionEnumSeq() {
        super(PositionEnum.class);
    }

    public PositionEnumSeq (int initialMaximum) {
        super(PositionEnum.class, initialMaximum);
    }

    public PositionEnumSeq (Collection<?> elements) {
        super(PositionEnum.class, elements);
    }

    public  PositionEnum get(int index) { 
        return (PositionEnum) super.get(index); 
    }
