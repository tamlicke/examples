...
/**
* A sequence of TeachTrocar instances.
*/
public final class TeachTrocarSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TeachTrocarSeq() {
        super(TeachTrocar.class);
    }

    public TeachTrocarSeq (int initialMaximum) {
        super(TeachTrocar.class, initialMaximum);
    }

    public TeachTrocarSeq (Collection<?> elements) {
        super(TeachTrocar.class, elements);
    }

    public  TeachTrocar get(int index) { 
        return (TeachTrocar) super.get(index); 
    }
