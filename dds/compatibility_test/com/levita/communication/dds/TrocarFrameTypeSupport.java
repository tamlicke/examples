...
public class TrocarFrameTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::TrocarFrame";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TrocarFrameTypeSupport _singleton
    = new TrocarFrameTypeSupport();
    ...
    */
    public static TrocarFrameTypeSupport get_instance() {
        return _singleton;
    }

    public static TrocarFrameTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TrocarFrameTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return TrocarFrame.create();
    }
    ...
    * <code>this</code> is not a <code>TrocarFrame</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        TrocarFrame typedDst = (TrocarFrame) destination;
        TrocarFrame typedSrc = (TrocarFrame) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        TrocarFrame typedSrc = (TrocarFrame) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.x);
            dst.writeDouble(typedSrc.y);
            dst.writeDouble(typedSrc.z);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TrocarFrame typedDst = (TrocarFrame) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.x = src.readDouble();
                typedDst.y = src.readDouble();
                typedDst.z = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TrocarFrame typedDst = (TrocarFrame) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TrocarFrameDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TrocarFrameDataReader(native_reader, listener, mask, this);   
    ...
    protected TrocarFrameTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TrocarFrameTypeCode.VALUE, TrocarFrame.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TrocarFrameTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TrocarFrameTypeCode.VALUE, TrocarFrame.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
