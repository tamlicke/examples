...
public class JointAnglesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::JointAngles";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointAnglesTypeSupport _singleton
    = new JointAnglesTypeSupport();
    ...
    */
    public static JointAnglesTypeSupport get_instance() {
        return _singleton;
    }

    public static JointAnglesTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointAnglesTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return JointAngles.create();
    }
    ...
    * <code>this</code> is not a <code>JointAngles</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        JointAngles typedDst = (JointAngles) destination;
        JointAngles typedSrc = (JointAngles) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        JointAngles typedSrc = (JointAngles) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 7; ++i1__){
                ...
                dst.writeDouble(typedSrc.jointAngles[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            JointAngles typedDst = (JointAngles) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                for(int i1__ = 0; i1__< 7; ++i1__){
                    ...
                    typedDst.jointAngles[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            JointAngles typedDst = (JointAngles) sample;
            deserialize_sample(
    ...
    int mask) {
        return new JointAnglesDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new JointAnglesDataReader(native_reader, listener, mask, this);   
    ...
    protected JointAnglesTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, JointAnglesTypeCode.VALUE, JointAngles.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected JointAnglesTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, JointAnglesTypeCode.VALUE, JointAngles.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
