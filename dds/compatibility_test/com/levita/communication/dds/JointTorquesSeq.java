...
/**
* A sequence of JointTorques instances.
*/
public final class JointTorquesSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointTorquesSeq() {
        super(JointTorques.class);
    }

    public JointTorquesSeq (int initialMaximum) {
        super(JointTorques.class, initialMaximum);
    }

    public JointTorquesSeq (Collection<?> elements) {
        super(JointTorques.class, elements);
    }

    public  JointTorques get(int index) { 
        return (JointTorques) super.get(index); 
    }
