...
/**
* A sequence of LogCommandEnum instances.
*/
public final class LogCommandEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LogCommandEnumSeq() {
        super(LogCommandEnum.class);
    }

    public LogCommandEnumSeq (int initialMaximum) {
        super(LogCommandEnum.class, initialMaximum);
    }

    public LogCommandEnumSeq (Collection<?> elements) {
        super(LogCommandEnum.class, elements);
    }

    public  LogCommandEnum get(int index) { 
        return (LogCommandEnum) super.get(index); 
    }
