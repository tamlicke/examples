...
public class TCPForceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::TCPForce";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TCPForceTypeSupport _singleton
    = new TCPForceTypeSupport();
    ...
    */
    public static TCPForceTypeSupport get_instance() {
        return _singleton;
    }

    public static TCPForceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TCPForceTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return TCPForce.create();
    }
    ...
    * <code>this</code> is not a <code>TCPForce</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        TCPForce typedDst = (TCPForce) destination;
        TCPForce typedSrc = (TCPForce) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        TCPForce typedSrc = (TCPForce) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeDouble(typedSrc.force[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TCPForce typedDst = (TCPForce) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                for(int i1__ = 0; i1__< 3; ++i1__){
                    ...
                    typedDst.force[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TCPForce typedDst = (TCPForce) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TCPForceDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TCPForceDataReader(native_reader, listener, mask, this);   
    ...
    protected TCPForceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TCPForceTypeCode.VALUE, TCPForce.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TCPForceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TCPForceTypeCode.VALUE, TCPForce.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
