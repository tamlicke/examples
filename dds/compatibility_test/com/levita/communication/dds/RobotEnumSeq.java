...
/**
* A sequence of RobotEnum instances.
*/
public final class RobotEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RobotEnumSeq() {
        super(RobotEnum.class);
    }

    public RobotEnumSeq (int initialMaximum) {
        super(RobotEnum.class, initialMaximum);
    }

    public RobotEnumSeq (Collection<?> elements) {
        super(RobotEnum.class, elements);
    }

    public  RobotEnum get(int index) { 
        return (RobotEnum) super.get(index); 
    }
