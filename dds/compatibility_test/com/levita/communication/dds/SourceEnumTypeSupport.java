...
public class SourceEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::SourceEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SourceEnumTypeSupport _singleton
    = new SourceEnumTypeSupport();
    ...
    */
    public static SourceEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static SourceEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SourceEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SourceEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        SourceEnum typedSrc = (SourceEnum) src;
    ...
    protected SourceEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, SourceEnumTypeCode.VALUE, SourceEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
