...
/**
* A sequence of DirectionEnum instances.
*/
public final class DirectionEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DirectionEnumSeq() {
        super(DirectionEnum.class);
    }

    public DirectionEnumSeq (int initialMaximum) {
        super(DirectionEnum.class, initialMaximum);
    }

    public DirectionEnumSeq (Collection<?> elements) {
        super(DirectionEnum.class, elements);
    }

    public  DirectionEnum get(int index) { 
        return (DirectionEnum) super.get(index); 
    }
