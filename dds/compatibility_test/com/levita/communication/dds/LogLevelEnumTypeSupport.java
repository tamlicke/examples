...
public class LogLevelEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::LogLevelEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LogLevelEnumTypeSupport _singleton
    = new LogLevelEnumTypeSupport();
    ...
    */
    public static LogLevelEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static LogLevelEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LogLevelEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LogLevelEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        LogLevelEnum typedSrc = (LogLevelEnum) src;
    ...
    protected LogLevelEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, LogLevelEnumTypeCode.VALUE, LogLevelEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
