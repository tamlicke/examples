...
/**
* A sequence of EventEnum instances.
*/
public final class EventEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EventEnumSeq() {
        super(EventEnum.class);
    }

    public EventEnumSeq (int initialMaximum) {
        super(EventEnum.class, initialMaximum);
    }

    public EventEnumSeq (Collection<?> elements) {
        super(EventEnum.class, elements);
    }

    public  EventEnum get(int index) { 
        return (EventEnum) super.get(index); 
    }
