...
* FootControllerPositionEnum
*/

public class FootControllerPositionEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::FootControllerPositionEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FootControllerPositionEnumTypeSupport _singleton
    = new FootControllerPositionEnumTypeSupport();
    ...
    */
    public static FootControllerPositionEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static FootControllerPositionEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FootControllerPositionEnumTypeCode.VALUE;
    }
    ...
    public Class<?> get_type() {
        return FootControllerPositionEnum.class;
    }
    ...
    * <code>this</code> is not a <code>FootControllerPositionEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        FootControllerPositionEnum typedSrc = (FootControllerPositionEnum) src;
    ...
    protected FootControllerPositionEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, FootControllerPositionEnumTypeCode.VALUE, FootControllerPositionEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
