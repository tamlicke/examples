...
public class DirectionEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::DirectionEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DirectionEnumTypeSupport _singleton
    = new DirectionEnumTypeSupport();
    ...
    */
    public static DirectionEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static DirectionEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DirectionEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>DirectionEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        DirectionEnum typedSrc = (DirectionEnum) src;
    ...
    protected DirectionEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, DirectionEnumTypeCode.VALUE, DirectionEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
