...
public class CartesianPositionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::CartesianPosition";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CartesianPositionTypeSupport _singleton
    = new CartesianPositionTypeSupport();
    ...
    */
    public static CartesianPositionTypeSupport get_instance() {
        return _singleton;
    }

    public static CartesianPositionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CartesianPositionTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return CartesianPosition.create();
    }
    ...
    public Class<?> get_type() {
        return CartesianPosition.class;
    }
    ...
    * <code>this</code> is not a <code>CartesianPosition</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        CartesianPosition typedDst = (CartesianPosition) destination;
        CartesianPosition typedSrc = (CartesianPosition) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getDoubleArrayMaxSizeSerialized(currentAlignment,  (3));
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        CartesianPosition typedSrc = (CartesianPosition) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getDoubleArrayMaxSizeSerialized(epd.getAlignment(currentAlignment),  (3));
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeDouble(typedSrc.coordinate[i1__]);
            }

            dst.writeDouble(typedSrc.A);
            dst.writeDouble(typedSrc.B);
            dst.writeDouble(typedSrc.C);
            dst.writeDouble(typedSrc.turn);
            dst.writeDouble(typedSrc.redundancyAngle);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CartesianPosition typedDst = (CartesianPosition) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                for(int i1__ = 0; i1__< 3; ++i1__){
                    ...
                    typedDst.coordinate[i1__] = src.readDouble();
                }

                typedDst.A = src.readDouble();
                typedDst.B = src.readDouble();
                typedDst.C = src.readDouble();
                typedDst.turn = src.readDouble();
                typedDst.redundancyAngle = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CartesianPosition typedDst = (CartesianPosition) sample;
            deserialize_sample(
    ...
    int mask) {
        return new CartesianPositionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CartesianPositionDataReader(native_reader, listener, mask, this);   
    ...
    protected CartesianPositionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CartesianPositionTypeCode.VALUE, CartesianPosition.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CartesianPositionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, CartesianPositionTypeCode.VALUE, CartesianPosition.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
