...
public class EStopStateEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::EStopStateEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EStopStateEnumTypeSupport _singleton
    = new EStopStateEnumTypeSupport();
    ...
    */
    public static EStopStateEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static EStopStateEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EStopStateEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>EStopStateEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        EStopStateEnum typedSrc = (EStopStateEnum) src;
    ...
    protected EStopStateEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, EStopStateEnumTypeCode.VALUE, EStopStateEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
