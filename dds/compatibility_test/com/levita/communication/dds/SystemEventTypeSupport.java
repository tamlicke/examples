...
public class SystemEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::SystemEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SystemEventTypeSupport _singleton
    = new SystemEventTypeSupport();
    ...
    */
    public static SystemEventTypeSupport get_instance() {
        return _singleton;
    }

    public static SystemEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SystemEventTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SystemEvent</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        SystemEvent typedDst = (SystemEvent) destination;
        SystemEvent typedSrc = (SystemEvent) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=com.levita.communication.dds.EventEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.levita.communication.dds.EventEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        SystemEvent typedSrc = (SystemEvent) sample;
        ...
        currentAlignment += com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.source);

        currentAlignment += com.levita.communication.dds.EventEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.event);

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.detail );
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=com.levita.communication.dds.EventEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (128)+1);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            com.levita.communication.dds.EventEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.event, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            dst.writeString(typedSrc.detail,128);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                SystemEvent typedSrc = (SystemEvent) src;      
                dst.inBaseClass = false;
                com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.source, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                com.levita.communication.dds.EventEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.event, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                dst.writeString(typedSrc.detail,128);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SystemEvent typedDst = (SystemEvent) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.source = (com.levita.communication.dds.SourceEnum)com.levita.communication.dds.SourceEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.source, src, false, true, endpoint_plugin_qos);     
                typedDst.event = (com.levita.communication.dds.EventEnum)com.levita.communication.dds.EventEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.event, src, false, true, endpoint_plugin_qos);     
                typedDst.detail = src.readString(128);
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.levita.communication.dds.EventEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SystemEvent typedDst = (SystemEvent) sample;
            deserialize_sample(
    ...
    int mask) {
        return new SystemEventDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SystemEventDataReader(native_reader, listener, mask, this);   
    ...
    protected SystemEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, SystemEventTypeCode.VALUE, SystemEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SystemEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, SystemEventTypeCode.VALUE, SystemEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
