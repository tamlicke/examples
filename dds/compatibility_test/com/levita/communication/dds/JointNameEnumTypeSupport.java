...
public class JointNameEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::JointNameEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final JointNameEnumTypeSupport _singleton
    = new JointNameEnumTypeSupport();
    ...
    */
    public static JointNameEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static JointNameEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return JointNameEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>JointNameEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        JointNameEnum typedSrc = (JointNameEnum) src;
    ...
    protected JointNameEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, JointNameEnumTypeCode.VALUE, JointNameEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
