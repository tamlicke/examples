...
public class  TeachTrocarTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("com::levita::communication::dds::TeachTrocar",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);        
        return tc;
    }
}
