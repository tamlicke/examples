...
/**
* A sequence of EmergencyStop instances.
*/
public final class EmergencyStopSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EmergencyStopSeq() {
        super(EmergencyStop.class);
    }

    public EmergencyStopSeq (int initialMaximum) {
        super(EmergencyStop.class, initialMaximum);
    }

    public EmergencyStopSeq (Collection<?> elements) {
        super(EmergencyStop.class, elements);
    }

    public  EmergencyStop get(int index) { 
        return (EmergencyStop) super.get(index); 
    }
