...
public class CoordinateEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::CoordinateEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CoordinateEnumTypeSupport _singleton
    = new CoordinateEnumTypeSupport();
    ...
    */
    public static CoordinateEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static CoordinateEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CoordinateEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CoordinateEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        CoordinateEnum typedSrc = (CoordinateEnum) src;
    ...
    protected CoordinateEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CoordinateEnumTypeCode.VALUE, CoordinateEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
