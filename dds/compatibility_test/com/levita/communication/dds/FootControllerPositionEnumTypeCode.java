...
public class  FootControllerPositionEnumTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_enum_tc("com::levita::communication::dds::FootControllerPositionEnum",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  em , annotation);        
        return tc;
    }
}
