...
/**
* A sequence of RobotCommand instances.
*/
public final class RobotCommandSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RobotCommandSeq() {
        super(RobotCommand.class);
    }

    public RobotCommandSeq (int initialMaximum) {
        super(RobotCommand.class, initialMaximum);
    }

    public RobotCommandSeq (Collection<?> elements) {
        super(RobotCommand.class, elements);
    }

    public  RobotCommand get(int index) { 
        return (RobotCommand) super.get(index); 
    }
