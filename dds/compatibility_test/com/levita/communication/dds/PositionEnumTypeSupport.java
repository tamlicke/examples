...
public class PositionEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::PositionEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PositionEnumTypeSupport _singleton
    = new PositionEnumTypeSupport();
    ...
    */
    public static PositionEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static PositionEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PositionEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>PositionEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        PositionEnum typedSrc = (PositionEnum) src;
    ...
    protected PositionEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, PositionEnumTypeCode.VALUE, PositionEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
