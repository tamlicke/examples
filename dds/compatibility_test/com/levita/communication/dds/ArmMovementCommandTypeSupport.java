...
public class ArmMovementCommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::ArmMovementCommand";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ArmMovementCommandTypeSupport _singleton
    = new ArmMovementCommandTypeSupport();
    ...
    */
    public static ArmMovementCommandTypeSupport get_instance() {
        return _singleton;
    }

    public static ArmMovementCommandTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ArmMovementCommandTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return ArmMovementCommand.create();
    }
    ...
    public Class<?> get_type() {
        return ArmMovementCommand.class;
    }
    ...
    * <code>this</code> is not a <code>ArmMovementCommand</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        ArmMovementCommand typedDst = (ArmMovementCommand) destination;
        ArmMovementCommand typedSrc = (ArmMovementCommand) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        ArmMovementCommand typedSrc = (ArmMovementCommand) sample;
        ...
        currentAlignment += com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.direction);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.direction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ArmMovementCommand typedSrc = (ArmMovementCommand) src;      
                dst.inBaseClass = false;
                com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.direction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ArmMovementCommand typedDst = (ArmMovementCommand) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.direction = (com.levita.communication.dds.DirectionEnum)com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.direction, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.levita.communication.dds.DirectionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ArmMovementCommand typedDst = (ArmMovementCommand) sample;
            deserialize_sample(
    ...
    int mask) {
        return new ArmMovementCommandDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ArmMovementCommandDataReader(native_reader, listener, mask, this);   
    ...
    protected ArmMovementCommandTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, ArmMovementCommandTypeCode.VALUE, ArmMovementCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ArmMovementCommandTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, ArmMovementCommandTypeCode.VALUE, ArmMovementCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
