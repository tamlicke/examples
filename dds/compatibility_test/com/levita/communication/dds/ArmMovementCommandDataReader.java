...
/**
* A reader for the ArmMovementCommand user type.
*/
public class ArmMovementCommandDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(ArmMovementCommandSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(ArmMovementCommandSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(ArmMovementCommandSeq received_data, 
    ...
    public void take_w_condition(ArmMovementCommandSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(ArmMovementCommand received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(ArmMovementCommand received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(ArmMovementCommandSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(ArmMovementCommandSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(ArmMovementCommandSeq received_data,
    ...
    public void take_instance_w_condition(ArmMovementCommandSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(ArmMovementCommandSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(ArmMovementCommandSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(ArmMovementCommandSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(ArmMovementCommandSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(ArmMovementCommandSeq received_data, SampleInfoSeq info_seq) {
        return_loan_untyped(received_data, info_seq);
    }

    public void get_key_value(ArmMovementCommand key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(ArmMovementCommand key_holder) {
    ...
    /*package*/  ArmMovementCommandDataReader (long native_reader, DataReaderListener listener,
