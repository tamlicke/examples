...
public class TCPExternalTorqueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::TCPExternalTorque";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TCPExternalTorqueTypeSupport _singleton
    = new TCPExternalTorqueTypeSupport();
    ...
    */
    public static TCPExternalTorqueTypeSupport get_instance() {
        return _singleton;
    }

    public static TCPExternalTorqueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TCPExternalTorqueTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return TCPExternalTorque.create();
    }
    ...
    public Class<?> get_type() {
        return TCPExternalTorque.class;
    }
    ...
    * <code>this</code> is not a <code>TCPExternalTorque</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        TCPExternalTorque typedDst = (TCPExternalTorque) destination;
        TCPExternalTorque typedSrc = (TCPExternalTorque) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        TCPExternalTorque typedSrc = (TCPExternalTorque) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 3; ++i1__){
                ...
                dst.writeDouble(typedSrc.torque[i1__]);
            }

            for(int i1__ = 0; i1__< 3; ++i1__){

                dst.writeDouble(typedSrc.inaccuracy[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TCPExternalTorque typedDst = (TCPExternalTorque) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                for(int i1__ = 0; i1__< 3; ++i1__){
                    ...
                    typedDst.torque[i1__] = src.readDouble();
                }

                for(int i1__ = 0; i1__< 3; ++i1__){

                    typedDst.inaccuracy[i1__] = src.readDouble();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TCPExternalTorque typedDst = (TCPExternalTorque) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TCPExternalTorqueDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TCPExternalTorqueDataReader(native_reader, listener, mask, this);   
    ...
    protected TCPExternalTorqueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TCPExternalTorqueTypeCode.VALUE, TCPExternalTorque.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TCPExternalTorqueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TCPExternalTorqueTypeCode.VALUE, TCPExternalTorque.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
