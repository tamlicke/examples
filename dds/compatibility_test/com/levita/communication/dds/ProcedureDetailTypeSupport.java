...
public class ProcedureDetailTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "com::levita::communication::dds::ProcedureDetail";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += _cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment +=_cdrPrimitiveType.getDoubleMaxSizeSerialized(currentAlignment) ;
        currentAlignment += com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (128)+1);
        currentAlignment += _cdrPrimitiveType.getDoubleMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scope_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.magnet_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.foot_controller_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ...
                dst.writeString(typedSrc.procedure,128);
                dst.writeDouble(typedSrc.scope_length);
                com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.scope_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.magnet_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
                com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.foot_controller_position, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.scope_position = (com.levita.communication.dds.CartPositionEnum)com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scope_position, src, false, true, endpoint_plugin_qos);     
                typedDst.magnet_position = (com.levita.communication.dds.CartPositionEnum)com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.magnet_position, src, false, true, endpoint_plugin_qos);     
                typedDst.foot_controller_position = (com.levita.communication.dds.FootControllerPositionEnum)com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.foot_controller_position, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            com.levita.communication.dds.CartPositionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            com.levita.communication.dds.FootControllerPositionEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
