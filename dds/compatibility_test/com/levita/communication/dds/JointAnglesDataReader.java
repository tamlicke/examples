...
/**
* A reader for the JointAngles user type.
*/
public class JointAnglesDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(JointAnglesSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(JointAnglesSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(JointAnglesSeq received_data, 
    ...
    public void take_w_condition(JointAnglesSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(JointAngles received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(JointAngles received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(JointAnglesSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(JointAnglesSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(JointAnglesSeq received_data,
    ...
    public void take_instance_w_condition(JointAnglesSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(JointAnglesSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(JointAnglesSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(JointAnglesSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(JointAnglesSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(JointAnglesSeq received_data, SampleInfoSeq info_seq) {
        return_loan_untyped(received_data, info_seq);
    }

    public void get_key_value(JointAngles key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(JointAngles key_holder) {
    ...
    /*package*/  JointAnglesDataReader (long native_reader, DataReaderListener listener,
