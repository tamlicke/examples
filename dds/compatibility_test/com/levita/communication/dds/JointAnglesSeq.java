...
/**
* A sequence of JointAngles instances.
*/
public final class JointAnglesSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointAnglesSeq() {
        super(JointAngles.class);
    }

    public JointAnglesSeq (int initialMaximum) {
        super(JointAngles.class, initialMaximum);
    }

    public JointAnglesSeq (Collection<?> elements) {
        super(JointAngles.class, elements);
    }

    public  JointAngles get(int index) { 
        return (JointAngles) super.get(index); 
    }
