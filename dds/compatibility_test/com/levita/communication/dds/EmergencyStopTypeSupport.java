...
public class EmergencyStopTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "com::levita::communication::dds::EmergencyStop";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().get_serialized_sample_size(
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.state, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                EmergencyStop typedSrc = (EmergencyStop) src;      
                dst.inBaseClass = false;
                com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.state, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.state = (com.levita.communication.dds.EStopStateEnum)com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.state, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.levita.communication.dds.EStopStateEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
