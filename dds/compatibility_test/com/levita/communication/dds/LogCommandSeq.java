...
/**
* A sequence of LogCommand instances.
*/
public final class LogCommandSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LogCommandSeq() {
        super(LogCommand.class);
    }

    public LogCommandSeq (int initialMaximum) {
        super(LogCommand.class, initialMaximum);
    }

    public LogCommandSeq (Collection<?> elements) {
        super(LogCommand.class, elements);
    }

    public  LogCommand get(int index) { 
        return (LogCommand) super.get(index); 
    }
