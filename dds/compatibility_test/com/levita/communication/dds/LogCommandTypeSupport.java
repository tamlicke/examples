...
public class LogCommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::LogCommand";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LogCommandTypeSupport _singleton
    = new LogCommandTypeSupport();
    ...
    */
    public static LogCommandTypeSupport get_instance() {
        return _singleton;
    }

    public static LogCommandTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LogCommandTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return LogCommand.create();
    }
    ...
    * <code>this</code> is not a <code>LogCommand</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        LogCommand typedDst = (LogCommand) destination;
        LogCommand typedSrc = (LogCommand) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment +=com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        currentAlignment += com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        LogCommand typedSrc = (LogCommand) sample;
        ...
        currentAlignment += com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.target);

        currentAlignment += com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.command);

        currentAlignment += com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.level);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=com.levita.communication.dds.SourceEnumTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.command, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().serialize(endpoint_data, typedSrc.level, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                LogCommand typedSrc = (LogCommand) src;      
                dst.inBaseClass = false;
                com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.target, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LogCommand typedDst = (LogCommand) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.target = (com.levita.communication.dds.SourceEnum)com.levita.communication.dds.SourceEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
                typedDst.command = (com.levita.communication.dds.LogCommandEnum)com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.command, src, false, true, endpoint_plugin_qos);     
                typedDst.level = (com.levita.communication.dds.LogLevelEnum)com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.level, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_key) {
            ...
            typedDst.target = (com.levita.communication.dds.SourceEnum)com.levita.communication.dds.SourceEnumTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
            if (!xcdr1 && !inBaseClass_tmp ) {
                buffer.restore(DHtmpSize, (int) (DHtmpPosition + DHtmpLength));
            }
        }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.levita.communication.dds.SourceEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            com.levita.communication.dds.LogCommandEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            com.levita.communication.dds.LogLevelEnumTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LogCommand typedDst = (LogCommand) sample;
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            if (!xcdr1 && !inBaseClass_tmp) {
            ...
            typedDst.target = (com.levita.communication.dds.SourceEnum)com.levita.communication.dds.SourceEnumTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.target, src, false, true, endpoint_plugin_qos);     
    ...
    */
    ...
    int mask) {
        return new LogCommandDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LogCommandDataReader(native_reader, listener, mask, this);   
    ...
    protected LogCommandTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, LogCommandTypeCode.VALUE, LogCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LogCommandTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, LogCommandTypeCode.VALUE, LogCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
