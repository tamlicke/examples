...
public class LogCommandEnumTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::levita::communication::dds::LogCommandEnum";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LogCommandEnumTypeSupport _singleton
    = new LogCommandEnumTypeSupport();
    ...
    */
    public static LogCommandEnumTypeSupport get_instance() {
        return _singleton;
    }

    public static LogCommandEnumTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LogCommandEnumTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>LogCommandEnum</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        LogCommandEnum typedSrc = (LogCommandEnum) src;
    ...
    protected LogCommandEnumTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, LogCommandEnumTypeCode.VALUE, LogCommandEnum.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
