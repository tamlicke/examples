...
/**
* A sequence of JointNameEnum instances.
*/
public final class JointNameEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public JointNameEnumSeq() {
        super(JointNameEnum.class);
    }

    public JointNameEnumSeq (int initialMaximum) {
        super(JointNameEnum.class, initialMaximum);
    }

    public JointNameEnumSeq (Collection<?> elements) {
        super(JointNameEnum.class, elements);
    }

    public  JointNameEnum get(int index) { 
        return (JointNameEnum) super.get(index); 
    }
