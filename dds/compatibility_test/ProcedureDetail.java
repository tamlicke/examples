...
public class ProcedureDetail   implements Copyable, Serializable{
    ...
    public CartPositionEnum scope_position = (CartPositionEnum)CartPositionEnum.valueOf(0);
    public CartPositionEnum magnet_position = (CartPositionEnum)CartPositionEnum.valueOf(0);
    public FootControllerPositionEnum foot_controller_position = (FootControllerPositionEnum)FootControllerPositionEnum.valueOf(0);
    ...
    public void clear() {
        ...
        scope_position = CartPositionEnum.valueOf(0);
        magnet_position = CartPositionEnum.valueOf(0);
        foot_controller_position = FootControllerPositionEnum.valueOf(0);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        typedDst.scope_position = (CartPositionEnum) typedDst.scope_position.copy_from(typedSrc.scope_position);
        typedDst.magnet_position = (CartPositionEnum) typedDst.magnet_position.copy_from(typedSrc.magnet_position);
        typedDst.foot_controller_position = (FootControllerPositionEnum) typedDst.foot_controller_position.copy_from(typedSrc.foot_controller_position);
