...
public class  ArmMovementCommandTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("direction", false, (short)-1,  false, DirectionEnumTypeCode.VALUE, 0, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("ArmMovementCommand",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);        
        return tc;
    }
}
