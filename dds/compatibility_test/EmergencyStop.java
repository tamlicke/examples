...
public class EmergencyStop   implements Copyable, Serializable{
    ...
    public EStopStateEnum state = (EStopStateEnum)EStopStateEnum.valueOf(0);
    ...
    public void clear() {
        ...
        state = EStopStateEnum.valueOf(0);
    ...
    */
    public Object copy_from(Object src) {
        ...
        typedDst.state = (EStopStateEnum) typedDst.state.copy_from(typedSrc.state);
