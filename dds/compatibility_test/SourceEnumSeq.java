...
/**
* A sequence of SourceEnum instances.
*/
public final class SourceEnumSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SourceEnumSeq() {
        super(SourceEnum.class);
    }

    public SourceEnumSeq (int initialMaximum) {
        super(SourceEnum.class, initialMaximum);
    }

    public SourceEnumSeq (Collection<?> elements) {
        super(SourceEnum.class, elements);
    }

    public  SourceEnum get(int index) { 
        return (SourceEnum) super.get(index); 
    }
